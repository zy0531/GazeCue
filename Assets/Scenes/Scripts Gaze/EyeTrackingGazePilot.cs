...
public class EyeTrackingGazePilot : MonoBehaviour
{
    ...
    private static readonly string[] ColumnNames = { 
        ...
        "targetLandmarkGroundTruthDirection",
    ...
    void Update()
    {
        ...
        if (logging)
        {
            if(GazePilotExperimentManager.isInUrbanEnvironment) // This line is added by Brooke
            {
    ...
    void LogGazeData(VarjoEyeTracking.GazeData data, VarjoEyeTracking.EyeMeasurements eyeMeasurements)
    {
        ...
        // Trial Info
        logData[32] = GazePilotExperimentManager.trialID_accumulated.ToString();
        logData[33] = GazePilotExperimentManager.trialID.ToString();
        logData[34] = GazePilotExperimentManager.displayMechanismType.ToString();
        logData[35] = GazePilotExperimentManager.combinations[GazePilotExperimentManager.combinationID][0].ToString();
        logData[36] = GazePilotExperimentManager.combinations[GazePilotExperimentManager.combinationID][1].ToString();
        logData[37] = GazePilotExperimentManager.currentTargetLandmark.ToString();
        logData[38] = GazePilotExperimentManager.currentLandmarkPlacement.ToString();
        logData[39] = GazePilotExperimentManager.targetLandmarkGroundTruth.ToString();

        // Gaze Cue
        logData[40] = gazeCue.isDwellDetected.ToString();
        logData[41] = gazeCue.isSaccadeDetected.ToString(); 
        logData[42] = gazeCue.visualFeedbackCount_near.ToString();
        logData[43] = gazeCue.visualFeedbackCount_far.ToString();
